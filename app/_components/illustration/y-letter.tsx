...
const YLetter = ({ className = "", ...props }: SVGProps) => {
  return (
    <svg className={className} width="252" height="252" viewBox="0 0 252 252" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="1" y="1" width="250" height="250" rx="60" stroke="black" stroke-width="2" stroke-dasharray="20 20" />
      <path d="M143.965 154.857V225.5H108.322V154.857C108.322 154.777 108.302 154.697 108.265 154.626L41.371 26.5H81.7421L125.979 118.502C126.063 118.676 126.238 118.786 126.43 118.786C126.623 118.785 126.798 118.675 126.881 118.501L170.832 26.5H210.632L144.022 154.627C143.985 154.698 143.965 154.777 143.965 154.857Z" fill="#DCDCDC" stroke="black" stroke-linejoin="round" />
      ...
      <line x1="113.931" y1="113.625" x2="137.973" y2="137.667" stroke="black" stroke-dasharray="2 2" />
      <line x1="113.224" y1="137.668" x2="137.266" y2="113.625" stroke="black" stroke-dasharray="2 2" />
    </svg>
  )
}
export { YLetter }
