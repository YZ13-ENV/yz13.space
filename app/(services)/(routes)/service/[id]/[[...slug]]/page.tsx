...
const page = ({ params }: Props) => {
  ...
  const asPage = service_route ? service_route.as ? service_route?.as : "widget" : "widget"
  if (!service) return redirect("/services")
  if (asPage === "page") return service_route?.entry
  return (
    <SplitViewContainer>
      <LeftSide>
        ...
        <>
          {
            empty_route
              ...
              : <>
                <header className="flex items-center justify-start gap-4 p-6">
