      ...
      <>
        <div className='min-h-screen w-full'>
          <div className="w-full">
            <div className="max-w-xl mx-auto w-full lg:py-12 px-6 md:py-6 py-6 space-y-6">
        ...
        </div>
        {
          ...
          <>
            <Separator />
            <div className="w-full">
              <section className="max-w-xl mx-auto w-full lg:py-12 px-6 md:py-6 py-6 space-y-6">
