...
const page = async ({ params }: Props) => {
  ...
  return (
    <>
      ...
      <div className="w-full py-24 space-y-12 h-fit">
        ...
        <Separator />
        <div className="container flex lg:flex-row flex-col items-start gap-6">
                      ...
                      key => {
                        ...
                        return (
                          <div key={"commits-group-" + key} className="w-full py-2 relative flex flex-col gap-2">
                            ...
                            <Separator orientation="vertical" className="absolute left-[13px] -top-0.5 z-[-1]" />
                          </div>
                        )
                      }
                    )
